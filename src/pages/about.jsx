      ...
      <article className="about">
        ...
        <section className="about-context">
          <div>
            <h1>About Ceviz</h1>
            <p>
              <strong>ceviz.io</strong> is a technology blog where I mostly share my software experiences, problems and
              projects I encounter on a weekly basis. It is also a small contribution to the open source world. All
              kinds of questions, opinions, suggestions, even 'I have an idea but..' everything you say. Feel free to
              contact with me on my e-mail (burak@ceviz.io).
            </p>
            <h2 id="personalinformations">Personal Informations</h2>
            <p>
              I was born in Balikesir/Turkey at 1993 of July. In 1998, my father bought a computer that name is
              "Escort". I learnt using PC with Chip and PCOyun magazines. The first website that I entered with ixir and
              56K modem (that's my first internet provider) is grafi2000. When we realized that the internet was
              something that could end, I unplugged it and played flash games with offline mode of Internet Explorer.
            </p>
            ...
            <hr />
            <p>
              Gratis’s corporate and career website. Includes job applications, employee interviews, information about
              the company.
            </p>
            <ul>
              <li>
            ...
            <p>
              HotNews is mobile news application. The news shared from the user interface are sent as a notification to
              the users’ mobile phones upon request. It has the features of showing news according to the location,
              recording the news, commenting on the news.
            </p>
            <ul>
              <li>
                <strong>Stacks:</strong>
            ...
            <p>
              ...
              learn. I used Papan01 themes on my site. If you are wondering how to install, deploy and improve, here
              url:{' '}
            ...
            <p>
              GitHub Repo:{' '}
              <a href="https://github.com/mindlabcore/ceviz-blog">https://github.com/mindlabcore/ceviz-blog</a>
            </p>
            <ul>
              <li>
                <strong>Stacks:</strong>
            ...
            <p>
              It is a simple remote control system project with http socket using a simple Arduino Uno and a few leds.
              You can find my blog post, the details of which can be found at the following link:{' '}
